...
The core part of ROOT is the C++ interpreter \textttt{Cling}, which is build on the top of the C++ compiler Clang. The interpreter allows users to have interactive ROOT sessions. It also serves as a backend for some of ROOT's language bindings such as ROOT Python extension module PyROOT.
